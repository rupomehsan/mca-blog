    ...
    <div id="sidebar-wrapper">
        <div class="brand-logo">
            <router-link :to="{ name: `adminDashboard` }" class="d-flex align-items-center">
                <img src="frontend/images/logo.png" class="logo-icon" alt="logo icon" />
        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="mm-collapse" style="border: 1px solid rgba(128, 128, 128, 0.267)">
                <router-link :to="{ name: `AllCategory` }" class="" href="javascript:void();">
                    <div class="menu-title">Category</div>
                </router-link>
            </li>
            <li class="mm-collapse" style="border: 1px solid rgba(128, 128, 128, 0.267)">
                <router-link :to="{ name: `AllSlider` }" class="" href="javascript:void();">
            ...
            <side-bar-drop-down-menus :icon="`fa fa-plus`" :menu_title="`Course Management`" :menus="[
                {
            ...
            <li class="mm-collapse" style="border: 1px solid rgba(128, 128, 128, 0.267)">
                <router-link :to="{ name: `ContactUs` }" class="" href="javascript:void();">
                    <div class="menu-title">Contact us</div>
                </router-link>

            </li>
            <li class="mm-collapse" style="border: 1px solid rgba(128, 128, 128, 0.267)">
                <router-link :to="{ name: `AllWebsiteSetting` }" class="" href="javascript:void();">
