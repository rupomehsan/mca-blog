...
@section('content')
        ...
        <div class="outer-container">
            ...
            <div class="row clearfix">
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/recipe-8.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-5.jpg"
                                    alt="" /></div>
                            <div class="category">CHICKEN</div>
                            <h4><a href="{{ route('blog.details', 'slug') }}">Pressure-Cooker Beef Short Ribs with
                                    Chutney</a></h4>
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/recipe-9.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-4.jpg"
                                    alt="" /></div>
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/recipe-10.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-6.jpg"
                                    alt="" /></div>
                            <div class="category">Cooking Style</div>
                            <h4><a href="{{ route('blog.details', 'slug') }}">Pressure-Cooker Beef Short Ribs with
                                    Chutney</a></h4>
                            <div class="text">Discover a sleighload of tasty snacks that are just right for holiday
                                feasting.</div>
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/recipe-11.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-7.jpg"
                                    alt="" /></div>
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/entertaining-5.jpg" alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-5.jpg"
                                    alt="" /></div>
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/entertaining-6.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-4.jpg"
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/entertaining-7.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-6.jpg"
                ...
                <div class="recipes-block style-three col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="{{ route('blog.details', 'slug') }}"><img
                                    src="{{ asset('frontend') }}/images/resource/entertaining-8.jpg"
                                    alt="" /></a>
                        </div>
                        <div class="lower-content">
                            <div class="author-image"><img src="{{ asset('frontend') }}/images/resource/author-7.jpg"
    ...
    <section class="call-to-action-section"
        style="background-image:url({{ asset('frontend') }}/images/background/2.jpg)">
        <div class="auto-container">
            <div class="row clearfix">
