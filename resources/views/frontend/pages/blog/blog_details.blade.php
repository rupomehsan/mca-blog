                    ...
                    <div class="inner-box">
                        ...
                        <div class="content" style="background-image:url(images/background/13.png)">
                            <div class="author-image">
                                <img src="{{ asset('frontend') }}/images/resource/author-9.jpg" alt="" />
                            </div>
                            ...
                            <div class="text">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum
                                dolore eu fugiat nulla pariatur. Title Image Lorem ipsum dolor sit amet</div>
                            <ul class="post-meta">
                        ...
                        <div class="text">Good Food sounds like the name of an amazingly delicious food delivery
                            service, but don't be fooled. The blog is actually a compilation of recipes, cooking videos,
                            and nutrition tips</div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="discription-para">
                                                                <img src="{{ asset('frontend') }}/images/resource/discription.jpg"
                                                                    alt="">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="discription-para">
                                                                <h4>The Best Sausage Pizzas Spread pizza sauce over
                                                                    crusts. At libero totam fugiat vero ab distinctio
                                                                    ducimus.</h4>
                                                                <p>Lorem ipsum dolor sit, amet, consectetur adipisicing
                                                                    elit. At libero totam fugiat vero ab distinctio
                                                                    ducimus, dolores deserunt inventore repellendus
                                                                    tempora fugit ipsum in alias placeat asperiores esse
                                                                    quaerat quibusdam omnis facilis laudantium. Placeat
                                                                    voluptatem nemo ea magnam modi quos esse accusamus
                                                                    possimus reiciendis, corporis rem quo, voluptatibus
                                                                    vel perferendis voluptates dolore.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="ingredients-block">
                                                        <div class="block-inner">
                                                            ...
                                                            <ul class="ingredients-list">
                                                                ...
                                                                <li>1 batch Best Pizza Dough (correct in RMS before
                                                                    running NAs)</li>
                                                    ...
                                                    <div class="ingredients-block">
                                                        <div class="block-inner">
                                                            ...
                                                            <ul class="direction-list">
                                                                <li><span>01</span><br>Divide dough in half. With
                                                                    greased fingers, pat each half onto an ungreased
                                                                    12-in. pizza pan. Prick dough thoroughly with a
                                                                    fork. Bake at 400° until lightly browned, 10-12
                                                                    minutes. Meanwhile, in a large skillet, cook the
                                                                    sausage over medium heat until sausage is no longer
                                                                    pink; drain.</li>
                                                                <li><span>02</span><br>Spread pizza sauce over crusts.
                                                                    Top with cheese, onion, green pepper, mushrooms and
                                                                    sausage. Bake at 400° until golden brown and cheese
                                                                    is bubbling, 12-15 minutes. If desired, top with
                                                                    grated Parmesan cheese, crushed red pepper flakes
                                                                    and fresh oregano leaves. Or wrap pizzas and freeze
                                                                    for up to 2 months.</li>
                                                                <li><span>03</span><br>To use frozen pizzas: Unwrap and
                                                                    place on pizza pans; thaw in the refrigerator. Bake
                                        ...
                                        <div class="tab-pane fade" id="pills-profile" role="tabpanel"
                                            ...
                                            <div class="video-boxed">
                                                ...
                                                <div class="video-box-two">
                                                    <div class="image">
                                                        <img src="{{ asset('frontend') }}/images/resource/video.jpg"
                                                            alt="" />
                                                        <a href="https://www.youtube.com/embed/sv3TXMSv6Lw"
                                            ...
                                            <div class="post-share-options">
                                                <div class="post-share-inner clearfix">
                                                    <div class="pull-left tags"><span class="fa fa-share"></span><a
                                                            ...
                                                            .</a> <a href="#">Linkein .</a> <a href="#">Pinterest .</a>
                                                        <a href="#">Instragram</a>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-contact" role="tabpanel"
                                                    ...
                                                    <div class="row clearfix">
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                                            <div class="clearfix">
                                                                ...
                                                                <div class="pull-right">
                                                                    <button class="theme-btn comment-btn" type="submit"
                                                                        name="submit-form">Post
                                                                        Review</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="comments-area">
                                                ...
                                                <div class="comment-box">
                                                    <div class="comment">
                                                        <div class="author-thumb"><img
                                                                src="{{ asset('frontend') }}/images/resource/author-15.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="comment-info clearfix">
                                                            <div class="comment-time">1 months ago · 0 Likes</div>
                                                        </div>
                                                        <div class="text">Duis aute irure dolor in reprehenderit in
                                                            voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                                            Excepteur sint occaecat cupidatat non proident, sunt in…Sed
                                                ...
                                                <div class="comment-box">
                                                    <div class="comment">
                                                        <div class="author-thumb"><img
                                                                src="{{ asset('frontend') }}/images/resource/author-16.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="comment-info clearfix">
                                                            <div class="comment-time">12 january 2020 · 2 Likes</div>
                                                        </div>
                                                        <div class="text">Duis aute irure dolor in reprehenderit in
                                                            voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                                ...
                                                <div class="comment-box reply-comment">
                                                    <div class="comment">
                                                        <div class="author-thumb"><img
                                                                src="{{ asset('frontend') }}/images/resource/author-17.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="comment-info clearfix">
                                                ...
                                                <div class="comment-box">
                                                    <div class="comment">
                                                        <div class="author-thumb"><img
                                                                src="{{ asset('frontend') }}/images/resource/author-18.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="comment-info clearfix">
                                                            <div class="comment-time">12 january 2020 · 0 Likes</div>
                                                        </div>
                                                        <div class="text">Duis aute irure dolor in reprehenderit in
                                                            voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                                                            Excepteur sint occaecat cupidatat non proident, sunt in…
                                                ...
                                                <div class="comment-box reply-comment">
                                                    <div class="comment">
                                                        <div class="author-thumb"><img
                                                                src="{{ asset('frontend') }}/images/resource/author-19.jpg"
                                                                alt="">
                                                        </div>
                                                        <div class="comment-info clearfix">
                            ...
                            <div class="row clearfix">
                                    ...
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="recipes-detail.html"><img
                                                    src="{{ asset('frontend') }}/images/resource/recipe-23.jpg"
                                                    alt="" /></a>
                                        </div>
                                        <div class="lower-content">
                                            <div class="author-image"><a href="author-details.html"><img
                                                        src="{{ asset('frontend') }}/images/resource/author-3.jpg"
                                                        alt="" /></a></div>
                                            <div class="category">CHICKEN</div>
                                            <h4><a href="recipes-detail.html">Pressure-Cooker Beef Short Ribs with
                                                    Chutney</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="recipes-block style-two col-lg-4 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="recipes-detail.html"><img
                                                    src="{{ asset('frontend') }}/images/resource/recipe-24.jpg"
                                                    alt="" /></a>
                                        </div>
                                        <div class="lower-content">
                                            <div class="author-image"><a href="author-details.html"><img
                                                        ...
                                                        alt="" /></a></div>
                                            <div class="category">CHICKEN</div>
                                            <h4><a href="recipes-detail.html">Pressure-Cooker Beef Short <br> Ribs with
                                                    Chutney</a></h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="recipes-block style-two col-lg-4 col-md-6 col-sm-12">
                                    <div class="inner-box">
                                        <div class="image">
                                            <a href="recipes-detail.html"><img
                                                    src="{{ asset('frontend') }}/images/resource/recipe-25.jpg"
                                                    alt="" /></a>
                                        </div>
                                        <div class="lower-content">
                                            <div class="author-image"><a href="author-details.html"><img
