            ...
            <div class="row clearfix">
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    <div class="recipe-detail">
                        <div class="inner-box">
                            <div class="image">
                                <img src="{{ asset('frontend') }}/images/resource/recipe-22.jpg" alt="" />
                            </div>
                                    ...
                                    <div class="ingredients-block">
                                        <div class="block-inner">
                                            ...
                                            <ul class="direction-list">
                                                <li><span>01</span><br>Divide dough in half. With greased fingers, pat each
                                                    half onto an ungreased 12-in. pizza pan. Prick dough thoroughly with a
                                                    fork. Bake at 400° until lightly browned, 10-12 minutes. Meanwhile, in a
                                                    large skillet, cook the sausage over medium heat until sausage is no
                                                    longer pink; drain.</li>
                                                <li><span>02</span><br>Spread pizza sauce over crusts. Top with cheese,
                                                    onion, green pepper, mushrooms and sausage. Bake at 400° until golden
                                                    brown and cheese is bubbling, 12-15 minutes. If desired, top with grated
                                                    Parmesan cheese, crushed red pepper flakes and fresh oregano leaves. Or
                                                    wrap pizzas and freeze for up to 2 months.</li>
                                                <li><span>03</span><br>To use frozen pizzas: Unwrap and place on pizza pans;
                                                    thaw in the refrigerator. Bake at 400° for 18-22 minutes or until golden
                                                    brown.</li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="video-boxed">
                                ...
                                <div class="video-box-two">
                                    <div class="image">
                                        <img src="{{ asset('frontend') }}/images/resource/video-9.jpg" alt="" />
                            ...
                            <div class="post-share-options">
                                <div class="post-share-inner clearfix">
                                    <div class="pull-left tags"><span class="fa fa-share"></span><a href="#">Facebook
                                            .</a> <a href="#">Twitter .</a> <a href="#">Linkein .</a> <a
                                            href="#">Pinterest .</a> <a href="#">Instragram</a></div>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <div class="pull-right">
                                                    <button class="theme-btn comment-btn" type="submit"
                                                        name="submit-form">Post Review</button>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        <div class="author-thumb"><img
                                                src="{{ asset('frontend') }}/images/resource/author-15.jpg" alt="">
                                        </div>
                                        <div class="comment-info clearfix">
                                            <div class="comment-time">1 months ago · 0 Likes</div>
                                        </div>
                                        <div class="text">Duis aute irure dolor in reprehenderit in voluptate velit esse
                                            cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
                                            proident, sunt in…Sed ut perspiciatis unde omnis iste natus error sit voluptatem
                                            accusantium doloremque laudantium, totam rem aperiam</div>
                                        <a class="theme-btn reply-btn" href="#"><span class="icon fa fa-reply"></span>
                                            Reply</a>
                                ...
                                <div class="widget-content">
                                    <div class="single-item-carousel owl-carousel owl-theme">
                                        ...
                                        <div class="post-block">
                                            <div class="block-inner">
                                                <div class="image">
                                                    <img src="{{ asset('frontend') }}/images/resource/post-5.jpg"
                                                        alt="" />
                                                </div>
                                                <div class="lower-content">
                                                    <div class="author-image">
                                                        <img src="{{ asset('frontend') }}/images/resource/author-9.jpg"
                                                            alt="" />
                                                    </div>
                                                    <div class="category">mutton biryani</div>
                                                    <h4><a href="#">Pressure-Cooker Beef Short Ribs with Chutney</a>
                                                    </h4>
                                                </div>
                                            </div>
                                        </div>
