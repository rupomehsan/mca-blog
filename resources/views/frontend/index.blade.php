    ...
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <div class="image-column col-lg-5 col-md-12 col-sm-12">
                <div class="inner-column">
                    <div class="image">
                        <img src="{{ asset('frontend') }}/images/clients/ceo.jpeg" alt="" style="height: 500px;
                                width: 400px;
                                object-fit: cover;" />
                    </div>
                </div>
        ...
        <div class="sec-title centered">
            ...
            <div class="row clearfix mt-5">
                ...
                <div class="image-column col-lg-5 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <div class="image">
                            <img src="{{ asset('frontend') }}/images/clients/whyus.jpeg" alt="" style="height: 500px;
                                    width: 400px;
                                    object-fit: cover;" />
                        </div>
                    </div>
        ...
        <div class="row clearfix">
            ...
            <div class="column col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="sec-title light ">
                    ...
                    <div class="text text-dark">Special occasions call for extraordinary food. Whether your gathering is
